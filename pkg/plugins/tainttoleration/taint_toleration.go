...
func (pl *TaintToleration) Filter(
	...
	for _, toleration := range placement.Spec.Tolerations {
		...
		if toleration.Operator == clusterapiv1beta1.TolerationOpExists &&
			len(toleration.Value) > 0 {
			return plugins.PluginFilterResult{}, framework.NewStatus(
				pl.Name(),
				framework.Misconfigured,
...
func (pl *TaintToleration) RequeueAfter(
	ctx context.Context,
	placement *clusterapiv1beta1.Placement,
...
func isClusterTolerated(
	cluster *clusterapiv1.ManagedCluster,
	tolerations []clusterapiv1beta1.Toleration,
	inDecision bool,
) (bool, *plugins.PluginRequeueResult, string) {
	var minRequeue *plugins.PluginRequeueResult
...
func isTolerated(
	taint clusterapiv1.Taint,
	toleration clusterapiv1beta1.Toleration,
) (bool, *plugins.PluginRequeueResult, string) {
...
func getDecisionClusterNames(
	...
	decisions, err := handle.DecisionLister().
...
func getDecisionClusters(
	handle plugins.Handle,
	placement *clusterapiv1beta1.Placement,
) (sets.String, []*clusterapiv1.ManagedCluster) {
